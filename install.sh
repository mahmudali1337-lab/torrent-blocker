...
START_CMD="${BINARY} --log /var/log/remnanode/access.log --tag TORRENT --no-ssh-ban --no-finwait-ban --ban-duration 10 --conn-thresh 50 --sendq-thresh 10 --finwait-thresh 30"
GO_VERSION="1.22.3"
